      ...
      <main className="flex-grow pt-32 pb-24 px-margin-mobile md:px-margin-desktop max-w-4xl mx-auto w-full">
        ...
        <div className="space-y-8 text-ink-secondary text-base md:text-lg leading-relaxed font-ui-label">
          <section>
            ...
            <p>
              Welcome to Stellar_pay. By accessing or using our protocol, website, and services, you agree to be bound by these Terms of Service.
            </p>
          </section>
          ...
          <section className="border-t-2 border-dashed border-edge-neutral pt-8">
            ...
            <p>
              Stellar_pay operates as a non-custodial, decentralized escrow protocol built on the Stellar network and Soroban smart contracts. We do not hold your funds, nor can we access them. All transactions are governed purely by the smart contract code deployed on the network.
            </p>
          </section>
          ...
          <section className="border-t-2 border-dashed border-edge-neutral pt-8">
            ...
            <ul className="list-disc pl-6 space-y-2 marker:text-accent">
              ...
              <li>You understand that all smart contract interactions are final and cannot be reversed by Stellar_pay.</li>
            </ul>
          </section>
          ...
          <section className="border-t-2 border-dashed border-edge-neutral pt-8">
            ...
            <p>
              Stellar_pay charges zero platform fees. However, you are responsible for any Stellar network fees (gas) required to execute transactions, including deploying contracts, funding escrows, and claiming payouts.
            </p>
          </section>
          ...
          <section className="border-t-2 border-dashed border-edge-neutral pt-8">
            ...
            <p>
              Because Stellar_pay is a decentralized protocol, we do not mediate disputes between clients and freelancers. Funds are locked according to the cryptographic parameters agreed upon during contract deployment.
            </p>
          </section>
        </div>
      </main>
